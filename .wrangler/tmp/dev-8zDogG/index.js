(() => {
  ...
  // ../../.nvm/versions/node/v23.3.0/lib/node_modules/wrangler/templates/middleware/loader-sw.ts
  ...
  // .wrangler/tmp/bundle-kTl0jQ/middleware-insertion-facade.js
  __facade_registerInternal__([middleware_ensure_req_body_drained_default, middleware_miniflare3_json_error_default]);

  // node_modules/.pnpm/@cloudflare+kv-asset-handler@0.4.2/node_modules/@cloudflare/kv-asset-handler/dist/index.js
  ...
  async function handleRequest(event) {
    try {
      ...
      try {
        return await getAssetFromKV(event, {
          mapRequestToAsset: /* @__PURE__ */ __name(() => spaRequest, "mapRequestToAsset")
        });
      } catch (innerError) {
